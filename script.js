  ...
  content.innerHTML += `
    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 g-4">
        <div class="card h-100">
            ...
            <img class="card-img-top" src="${objData.flags.png}" alt="${
    objData.name.common
  }">
            <div class="card-body">
                <div class="card-text">
                    <p>Capital: ${
                      objData.capital == undefined ? "N/A" : objData.capital
                    }</p>
                    <p>Region: ${objData.region}</p>
                    <p>Country Code: ${objData.cioc ? objData.cioc : "N/A"}</p>
                    <p>Lat: ${
                      objData.latlng == undefined ? "N/A" : objData.latlng[0]
                    } Long: ${
...
async function buttonClick(lat, long, weatherTextId, btnID) {
  try {
    ...
    const APIURL =
      ...
      "&lon=" +
      long +
      "&appid=6f3505160a1685507f3841703b8e968d";
...
async function refreshWeather(refreshLat, refreshLong, weatherTextId) {
  try {
    ...
    const iconURL =
      ...
      latestWeatherData.weather[0].icon +
      ".png";
